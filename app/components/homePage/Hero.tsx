...
export default function Hero() {
    return (
        <section className="text-gray-600 body-font container mx-auto flex py-16 md:flex-row flex-col items-center">
