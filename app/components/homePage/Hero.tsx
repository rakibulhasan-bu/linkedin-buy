...
export default function Hero() {
    return (
        <section className="text-gray-600 body-font container mx-auto flex py-12 md:flex-row flex-col items-center">
            ...
            <div className="lg:max-w-xl md:w-1/2 w-5/6">
                <Image width={600} height={512} className="object-cover h-[80dvh] object-center rounded" alt="hero" src="https://res.cloudinary.com/dwx2jd8b1/image/upload/v1707330466/Website-assets/linkedin-buy/_ae723cb6-5db0-463d-afe7-b0f0afdec3a6.jpeg_caqfg5.jpg" />
            </div>
        </section>
    );
};
